...
if(isset($_POST['add_to_wishlist'])){
   ...
   if($user_id == ''){
      ...
      if($check_wishlist_numbers->rowCount() > 0){
         ...
         $insert_wishlist = $db->prepare("INSERT INTO `wishlist`(user_id, product_id, name, price, image) VALUES(?,?,?,?,?)");
...
if(isset($_POST['add_to_cart'])){
   ...
   if($user_id == ''){
      ...
      if($check_cart_numbers->rowCount() > 0){
         ...
         $insert_cart = $db->prepare("INSERT INTO `cart`(user_id, product_id, name, price, quantity, image) VALUES(?,?,?,?,?,?)");
